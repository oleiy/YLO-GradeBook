...
public class PopUpWindow {
    ...
    private void onAddGradeButtonClicked() {
        ...
        String dateAssigned = LocalDate.now().toString();
        ...
        double gradeValue = Double.parseDouble(selectedGrade.split(" - ")[0]);
        int weight = getWeightFromType(selectedType);
    ...
    //------------------------------------------------------------------------------------------------------
    //---------------------------- Method to add negative note to the database -----------------------------
    //------------------------------------------------------------------------------------------------------
