...
public class StudentWindow extends SessionController {
    ...
    // Method to refresh the notes table view
    @FXML
    ...
    // Method to load user notes from the database and display them in the table view
    ...
    // Method to delete a note from the database and the table view
    ...
    //Method that allows you to inflect Polish words for values
    ...
    //Method to get the class ID of the logged user
    ...
    //Method to get class name based on class ID
