...
public class TeacherWindow extends SessionController {
    ...
    //-------------------- Methods for class and subject selection --------------------
    @FXML
    ...
    //-------------------- Methods for getting subject and class IDs --------------------
    ...
    // Method to load subjects from the database
    ...
    // Method to calculate the average grade from a string of grades
